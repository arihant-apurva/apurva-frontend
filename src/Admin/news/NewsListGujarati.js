...
const NewsListGujarati = () => {
    ...
    let activeSort={}
    const BASE_URL = `https://apurva-backend-repo.onrender.com/api/search/news_gu?page=${page + 1}&limit=${rowsPerPage}&sort=${JSON.stringify(activeSort)}&filters=${JSON.stringify(filters)}`
            ...
            {loading ? <div className="modal">
                ...
                <>
                    ...
                    <div className="container d-flex flex-row justify-content-between align-self-center">
                        <p className="text-primary" style={{ fontSize: "200%", fontWeight: "550", height: '10px' }}>News (Gujarati)</p>
                        <buttonCONTENT
                            type="button"
                                ...
                                <tbody>
                                    {list.map((entry, index) => (
                                        <TableRow key={entry._id}>
                                            ...
                                            <TableCell>
                                                <NavLink to={`/admin/news/news_gu/view/${entry._id}`}>
                                                    {entry._id}
                                                </NavLink>
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            <TableCell className="text-center" colSpan={3} >
                                                ...
                                                <div className="d-flex justify-content-center gap-3">
                                                    ...
                                                    <button
                                                        type="button"
                                                        className="btn"
                                                        onClick={() => navigate(`/admin/news/news_gu/view/${entry._id}`)}
                                                    >
                                                        <i
...
export default NewsListGujarati;
