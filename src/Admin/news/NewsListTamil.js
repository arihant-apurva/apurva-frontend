...
const NewsListTamil = () => {
    ...
    let activeSort={}
    const BASE_URL = `https://apurva-backend-repo.onrender.com/api/search/news_ta?page=${page + 1}&limit=${rowsPerPage}&sort=${JSON.stringify(activeSort)}&filters=${JSON.stringify(filters)}`
